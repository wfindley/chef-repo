...
Vagrant.configure("2") do |config|
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/strllc"
  #   chef.validation_client_name = "strllc-validator"
  #   chef.validation_key_path = ".chef/strllc-validator.pem"
  # end
end
